...
public class ContainerInventoryFurnace extends Container {
	...
	private TileEntityFramedFurnace tileFurnace;
	...
	public ContainerInventoryFurnace(InventoryPlayer invPlayer, TileEntityFramedFurnace tileInventoryFurnace) {
		this.tileFurnace = tileInventoryFurnace;
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int sourceSlotIndex)
	{
		...
		if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
			...
			if (TileEntityFramedFurnace.getSmeltingResultForItem(sourceStack) != null){
	...
	public void detectAndSendChanges() {
		...
		for (int i = 0; i < cachedFields.length; ++i) {
			if (allFieldsHaveChanged || cachedFields[i] != tileFurnace.getField(i)) {
	...
	public class SlotFuel extends Slot {
		...
		public boolean isItemValid(ItemStack stack) {
			return TileEntityFramedFurnace.isItemValidForFuelSlot(stack);
		}
	}
	...
	public class SlotSmeltableInput extends Slot {
		...
		@Override
		public boolean isItemValid(ItemStack stack) {
			return TileEntityFramedFurnace.isItemValidForInputSlot(stack);
		}
	}
	...
	public class SlotOutput extends Slot {
		...
		@Override
		public boolean isItemValid(ItemStack stack) {
			return TileEntityFramedFurnace.isItemValidForOutputSlot(stack);
		}
	}
}