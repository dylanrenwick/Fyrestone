...
public class Config
{
	...
	public void setupCrafting()
	{
		...
		RitualRecipeManager.RegisterRecipe(new RitualRecipe(new ItemStack(ItemRegister.itemShard, 1, EnumShardType.WATERSTONE.ordinal()), 0, new ItemStack(ItemRegister.itemFyrestoneCatalyst), new ItemStack(Items.WATER_BUCKET), new ItemStack(Items.DYE, 1, EnumDyeColor.BLUE.getMetadata())));
	}
